#!/usr/bin/env python3
"""
Kestrel parallel_explorer.py — run N exploration tasks in parallel against Kali.
...
script is testable in CI without a Kali to talk to.

Usage:
    python3 scripts/parallel_explorer.py \\
        --tasks-json '{"tasks":[...]}' \\
