#!/usr/bin/env python3
"""
Kestrel state_inspector — query helper for last-cycle.json cross-session history.
...
Usage examples (legacy CLI):
    # Print all hashes tried against a machine
    python -m kestrel.core.state_inspector --state-file last-cycle.json \\
